...
def run_csp_benchmarks():
    print("--- Benchmark e Valutazione Modulo CSP (maintenance_optimizer) ---")
    ...
    for h in horizons:
        for c in crews_list:
            opt = maintenance_optimizer.WindFarmMaintenanceOptimizer(planning_days=h, max_crews=c)
    ...
    out_path = config.RESULTS_DIR / "csp_evaluation_wind_turbines.csv"
